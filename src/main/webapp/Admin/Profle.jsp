			        ...
			        <div class="card mb-4">
			          <div class="card-body">
			            <div class="row">
			              ...
			              <div class="col-sm-9">
			                <p class="text-muted mb-0"><%= request.getSession().getAttribute("first_name") %> <%= request.getSession().getAttribute("last_name") %> </p>
			              </div>
			            </div>
			            <hr>
			            <div class="row">
			              ...
			              <div class="col-sm-9">
			                <p class="text-muted mb-0"><%= request.getSession().getAttribute("email") %></p>
			              </div>
			            </div>
			            <hr>
			            <div class="row">
			              ...
			              <div class="col-sm-9">
			                <p class="text-muted mb-0">0<%= request.getSession().getAttribute("phone_no") %></p>
			              </div>
			            </div>
			            <hr>
			            <div class="row">
			              ...
			              <div class="col-sm-9">
			                <p class="text-muted mb-0"><%= request.getSession().getAttribute("address") %></p>
			              </div>
			            </div>
			          </div>
			        </div>
