					 ...
					 <tbody> 
						   ...
						   <% for(ProgressFileModel mod:modl){ %>
						    ...
						    <td>
						     ...
						     <a class="btn btn-success btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="View" href="Progressprint.jsp?id=<%=mod.getFileno()%>"><i class="fa fa-table"></i></a>
						       </li>                                           
						       <li class="list-inline-item">
