                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="../Registrationinsert" method="post">
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                     ...
                                     <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Address" name="Address">
                                     </div>
                    			</div>
                    			 <div class="form-group">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="Date" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="Professional_status" name="Date_of_birth">
